...
| [Stabilize feed scheduler for bulk and delta syncs](#foundation-hardening-stabilize-feed-scheduler-for-bulk-and-delta-syncs) | Complete | [SHU-234 Feeds Scheduler](./tasks/SHU-27-BACKGROUND-SCHEDULER/SHU-234-Plugin-Feeds-In-Process-Scheduler.md), [SHU-231 Concurrency & Idempotency](./tasks/SHU-27-BACKGROUND-SCHEDULER/SHU-231-Concurrency-Claims-and-Idempotency.md) |
...
| [Introduce dynamic work queues](#adaptive-deployment-platform-introduce-dynamic-work-queues) | Complete | [SHU-211 Queue interface](./tasks/SHU-24-Adaptive-Deployment-Platform/SHU-211-Queue-and-cache-interfaces-with-Redis-and-in-memory-backends.md), [SHU-215 Workload routing](./tasks/SHU-24-Adaptive-Deployment-Platform/SHU-215-Workload-routing-and-worker-roles-for-queues.md) |
| [Introduce unified cache abstraction](#adaptive-deployment-platform-introduce-unified-cache-abstraction) | Complete | [Unified Cache Interface](./tasks/SHU-24-Adaptive-Deployment-Platform/SHU-414-Unified-Cache-Interface-with-Redis-and-In-Memory-Backends.md) |
| [Implement workload routing patterns](#adaptive-deployment-platform-implement-workload-routing-patterns) | Complete | [SHU-215 Workload routing](./tasks/SHU-24-adaptive-deployment-platform/SHU-215-Workload-routing-and-worker-roles-for-queues.md) |
...
| [Adopt queue abstraction for scheduler](#adaptive-deployment-platform-adopt-queue-abstraction-for-scheduler) | Complete | [SHU-211 Queue interface](./tasks/SHU-24-Adaptive-Deployment-Platform/SHU-211-Queue-and-cache-interfaces-with-Redis-and-in-memory-backends.md) |
