...
class DemoIncidentHistoryPlugin:
        ...
        return {
            ...
            "properties": {
                ...
                "include_risk_assessment": {
                    "type": "boolean",
                    "default": True,
                    "x-ui": {"help": "Include risk assessment data in response"},
                },
                "include_behavioral_notes": {
                    "type": "boolean",
                    "default": True,
                    "x-ui": {"help": "Include behavioral notes in response"},
                },
            },
            "required": [],
    ...
    def get_output_schema(self) -> dict[str, Any]:
        ...
        incident_schema = {
            ...
            "properties": {
                ...
                "date": {"type": "string", "format": "date-time", "description": "Incident date and time"},
                "type": {
                    "type": "string",
                ...
                "resolved_by": {"type": "string", "description": "Staff member who resolved the incident"},
                "resolution_time_minutes": {
                    "type": "integer",
                    "description": "Time taken to resolve incident in minutes",
                },
                "player_satisfaction": {"type": "string", "description": "Player satisfaction level after resolution"},
                "follow_up_required": {"type": "boolean", "description": "Whether follow-up action is required"},
                "police_report": {"type": "string", "description": "Police report number (if applicable)"},
                "witnesses": {"type": "array", "items": {"type": "string"}, "description": "List of witnesses"},
                "injuries": {"type": "array", "items": {"type": "string"}, "description": "List of injuries sustained"},
                "review_date": {"type": "string", "format": "date", "description": "Date for review (if applicable)"},
            },
        ...
        behavioral_notes_schema = {
            "type": "object",
            "properties": {
                "temperament": {"type": "string", "description": "Player's general temperament"},
                "alcohol_consumption": {"type": "string", "description": "Alcohol consumption pattern"},
                "tipping_behavior": {"type": "string", "description": "Tipping behavior pattern"},
                "staff_interactions": {"type": "string", "description": "Quality of interactions with staff"},
        ...
        risk_assessment_schema = {
            "type": "object",
            "properties": {
                "problem_gambling_indicators": {"type": "string", "description": "Problem gambling risk indicators"},
                "credit_risk": {"type": "string", "description": "Credit risk level"},
                "security_risk": {"type": "string", "description": "Security risk level"},
        ...
        ban_details_schema = {
            "type": "object",
            "properties": {
                "ban_date": {"type": "string", "format": "date", "description": "Date ban was imposed"},
                "ban_type": {"type": "string", "enum": ["temporary", "permanent"], "description": "Type of ban"},
                "ban_reason": {"type": "string", "description": "Reason for ban"},
                "appeal_status": {"type": "string", "description": "Status of any appeal"},
                "appeal_date": {"type": "string", "format": "date", "description": "Date of appeal (if applicable)"},
                "trespass_notice_served": {"type": "boolean", "description": "Whether trespass notice has been served"},
                "police_involvement": {"type": "boolean", "description": "Whether police were involved"},
                "criminal_charges": {"type": "string", "description": "Criminal charges filed (if applicable)"},
            },
        ...
        restriction_details_schema = {
            "type": "object",
            "properties": {
                "restriction_type": {"type": "string", "description": "Type of restriction imposed"},
                "effective_date": {
                    "type": "string",
                    "format": "date",
                    "description": "Date restriction became effective",
                },
                "review_date": {"type": "string", "format": "date", "description": "Date for restriction review"},
                "reason": {"type": "string", "description": "Reason for restriction"},
                "compliance_status": {"type": "string", "description": "Player's compliance with restriction"},
        ...
        incident_history_schema = {
            ...
            "properties": {
                ...
                "incidents": {"type": "array", "items": incident_schema, "description": "Array of incident records"},
                "watchlist_status": {
                    "type": "string",
                    "enum": ["none", "standard_monitoring", "vip_protection", "high_priority", "banned_permanent"],
                    "description": "Current watchlist status",
                },
                "self_exclusion": {"type": "boolean", "description": "Whether player has self-excluded"},
                "regulatory_flags": {
                    "type": "array",
                    "items": {"type": "string"},
                    "description": "Regulatory compliance flags",
                },
                "credit_flags": {"type": "array", "items": {"type": "string"}, "description": "Credit-related flags"},
                "behavioral_notes": {**behavioral_notes_schema, "description": "Behavioral observation notes"},
                "risk_assessment": {**risk_assessment_schema, "description": "Comprehensive risk assessment"},
                "ban_details": {**ban_details_schema, "description": "Ban details (if player is banned)"},
                "restriction_details": {
                    **restriction_details_schema,
                    "description": "Restriction details (if player has restrictions)",
                },
                "summary": {"type": "string", "description": "Summary of incident history and player status"},
            },
            ...
            "oneOf": [
                {
                    ...
                    "properties": {
                        ...
                        "found": {"type": "boolean", "description": "Whether the player was found"},
                    },
                    "required": ["found"],
                    "additionalProperties": False,
    ...
    async def execute(self, params: dict[str, Any], context: Any, host: Any) -> dict[str, Any]:
        ...
        return {"status": "error", "data": None, "diagnostics": [f"Unknown operation: {op}"], "cost": {"api_calls": 0}}
    ...
    async def _get_by_player(self, params: dict[str, Any]) -> dict[str, Any]:
        ...
        if customer_id in DEMO_INCIDENT_HISTORIES:
            return {
                "status": "success",
                "data": {"incident_history": DEMO_INCIDENT_HISTORIES[customer_id], "found": True},
                "diagnostics": diagnostics,
                "cost": {"api_calls": 0},
            }
        diagnostics.append(f"Player not found: {customer_id}")
        return {"status": "success", "data": {"found": False}, "diagnostics": diagnostics, "cost": {"api_calls": 0}}
