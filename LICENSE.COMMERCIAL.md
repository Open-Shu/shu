...
If Licensee does not agree, Licensee may not use Shu under this Agreement and must instead use Shu under the terms of the GNU General Public License v3.0 as provided in `LICENSE.GPL-3.0`.
