...
NOTE: down_revision is temporarily set to r009_0001 because r009_0003
lives in a sibling PR that has not landed on this branch yet. Once the
sibling PR merges (or rebases under us), update down_revision to
r009_0003 before opening this PR for review.
...
revision = "r009_0004"
# TODO(SHU-811): bump to "r009_0003" once the sibling PR lands.
