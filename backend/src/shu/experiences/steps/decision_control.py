...
class DecisionControlStep:
    ...
    async def execute(
        self, step_key: str, config: dict[str, Any], context: dict[str, Any], host: Any | None = None
    ) -> dict[str, Any]:
    ...
    def _simple_decision(self, should_execute: bool, rationale: str) -> dict[str, Any]:
        ...
        Returns:
            Dict with keys: should_execute (bool), rationale (str), confidence (float)

        """
        return {"should_execute": should_execute, "rationale": rationale, "confidence": 1.0}
