...
class FileTooLargeError(ShuException):
    ...
    def __init__(self, file_path: str, size: int, max_size: int, details: Optional[Dict[str, Any]] = None):
        super().__init__(
...
class KnowledgeBaseNotFoundError(ShuException):
    ...
    def __init__(self, knowledge_base_id: str, details: Optional[Dict[str, Any]] = None):
        super().__init__(
...
class KnowledgeBaseSourceNotFoundError(ShuException):
    ...
    def __init__(self, source_id: str, details: Optional[Dict[str, Any]] = None):
        super().__init__(
...
class KnowledgeBaseSourceAlreadyExistsError(ShuException):
    ...
    def __init__(self, source_name: str, details: Optional[Dict[str, Any]] = None):
        super().__init__(
...
class KnowledgeBasePromptNotFoundError(ShuException):
    ...
    def __init__(self, prompt_id: str, details: Optional[Dict[str, Any]] = None):
        super().__init__(
...
class KnowledgeBasePromptAlreadyExistsError(ShuException):
    ...
    def __init__(self, prompt_name: str, details: Optional[Dict[str, Any]] = None):
        super().__init__(
...
class LLMAuthenticationError(LLMError):
    ...
    def __init__(self, message: str = "LLM authentication failed", details: Optional[Dict[str, Any]] = None):
        super().__init__(
            message=message,
