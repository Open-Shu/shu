...
from ..auth.rbac import require_kb_manage_access
...
async def grant_kb_permission(
    ...
    """
    logger.info("Granting KB permission", extra={
        "kb_id": kb_id,
    ...
    try:
        ...
        permission = await rbac_service.grant_kb_permission(
            kb_id, permission_data, current_user.id
        )
...
async def list_kb_permissions(
    ...
    """
    logger.info("Listing KB permissions", extra={
        "kb_id": kb_id,
...
async def revoke_kb_permission(
    ...
    """
    logger.info("Revoking KB permission", extra={
        "kb_id": kb_id,
    ...
    try:
        ...
        return ShuResponse.success(
            data={"revoked_permission_id": permission_id, "kb_id": kb_id}
        )
...
async def get_effective_permissions(
    ...
    logger.info("Getting effective permissions", extra={
        "kb_id": kb_id,
    ...
    try:
        ...
        return ShuResponse.success(
            data=effective_permission.model_dump()
        )
