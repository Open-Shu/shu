...
async def list_knowledge_bases(
    ...
    search: Optional[str] = Query(None, description="Search term for knowledge base names"),
    ...
    """
    logger.info("Listing knowledge bases", extra={
        "limit": limit,
        "offset": offset,
        "search": search
    })
    ...
    try:
        ...
        logger.error("Failed to list knowledge bases", extra={
            "error": str(e)
        })
        return ShuResponse.error(
            message=str(e),
            code="KNOWLEDGE_BASE_LIST_ERROR",
            status_code=e.status_code
        )
    except Exception as e:
        logger.error("Unexpected error listing knowledge bases", extra={
            "error": str(e)
        })
        return ShuResponse.error(
...
async def get_knowledge_base_stats(
    ...
    try:
        ...
        logger.error("Failed to get knowledge base statistics", extra={
            "error": str(e)
        })
        return ShuResponse.error(
            message=str(e),
            code="KNOWLEDGE_BASE_STATS_ERROR",
            status_code=e.status_code
        )
    except Exception as e:
        logger.error("Unexpected error getting knowledge base statistics", extra={
            "error": str(e)
        })
        return ShuResponse.error(
            message="Internal server error",
...
async def get_knowledge_base(
    ...
    try:
        ...
        logger.info("API: Retrieved knowledge base", extra={
            "kb_id": kb_id,
            "kb_name": result.name
        })
        ...
        logger.error("API: Failed to get knowledge base", extra={
            "kb_id": kb_id,
            "error": str(e)
        })
        return ShuResponse.error(
            message=str(e),
            code="KNOWLEDGE_BASE_GET_ERROR",
            status_code=e.status_code
        )
    except Exception as e:
        logger.error("API: Failed to get knowledge base", extra={
...
async def create_knowledge_base(
    ...
    try:
        ...
        logger.info("API: Created knowledge base", extra={
            "kb_id": result.id,
            "kb_name": result.name
        })
        ...
        logger.error("API: Failed to create knowledge base", extra={
            "kb_name": kb_data.name,
            "error": str(e)
        })
        return ShuResponse.error(
            message=str(e),
            code="KNOWLEDGE_BASE_CREATE_ERROR",
            status_code=e.status_code
        )
    except Exception as e:
        logger.error("API: Failed to create knowledge base", extra={
...
async def update_knowledge_base(
    ...
    try:
        ...
        logger.info("API: Updated knowledge base", extra={
            "kb_id": kb_id,
            "kb_name": result.name
        })
        ...
        logger.error("API: Failed to update knowledge base", extra={
            "kb_id": kb_id,
            "error": str(e)
        })
        return ShuResponse.error(
            message=str(e),
            code="KNOWLEDGE_BASE_UPDATE_ERROR",
            status_code=e.status_code
        )
    except Exception as e:
        logger.error("API: Failed to update knowledge base", extra={
...
async def delete_knowledge_base(
    ...
    try:
        ...
        logger.error("API: Failed to delete knowledge base", extra={
            "kb_id": kb_id,
            "error": str(e)
        })
        return ShuResponse.error(
...
async def get_knowledge_base_summary(
    ...
    try:
        ...
        logger.error("API: Failed to get knowledge base summary", extra={
            "kb_id": kb_id,
            "error": str(e)
        })
        return ShuResponse.error(
            message=str(e),
            code="KNOWLEDGE_BASE_SUMMARY_ERROR",
            status_code=e.status_code
        )
    except Exception as e:
        logger.error("API: Failed to get knowledge base summary", extra={
...
async def set_knowledge_base_status(
    ...
    try:
        ...
        logger.info("API: Set knowledge base status", extra={
            "kb_id": kb_id,
            "status": result.status
        })
        ...
        logger.error("API: Failed to set knowledge base status", extra={
            "kb_id": kb_id,
            "error": str(e)
        })
        return ShuResponse.error(
            message=str(e),
            code="KNOWLEDGE_BASE_STATUS_ERROR",
            status_code=e.status_code
        )
    except Exception as e:
        logger.error("API: Failed to set knowledge base status", extra={
...
async def validate_knowledge_base_config(
    ...
    try:
        ...
        logger.info("API: Validated knowledge base config", extra={
            "kb_id": kb_id,
        ...
        logger.error("API: Failed to validate knowledge base config", extra={
            "kb_id": kb_id,
            "error": str(e)
        })
        return ShuResponse.error(
            message=str(e),
            code="KNOWLEDGE_BASE_VALIDATE_ERROR",
            status_code=e.status_code
        )
    except Exception as e:
        logger.error("API: Failed to validate knowledge base config", extra={
...
async def get_rag_config(
    ...
    try:
        ...
        logger.error("Failed to get RAG configuration", extra={
            "kb_id": kb_id,
            "error": str(e)
        })
        return ShuResponse.error(
            message=str(e),
            code="RAG_CONFIG_GET_ERROR",
            status_code=e.status_code
        )
    except Exception as e:
        logger.error("Unexpected error getting RAG configuration", extra={
            "kb_id": kb_id,
            "error": str(e)
        })
        return ShuResponse.error(
...
async def get_rag_templates(
    ...
    try:
        ...
        logger.error("Unexpected error getting RAG templates", extra={
            "error": str(e)
        })
        return ShuResponse.error(
            message="Internal server error",
...
async def update_rag_config(
    ...
    Raises:
        HTTPException: If knowledge base not found or database error occurs
    """
    logger.info("Updating RAG configuration", extra={
        "kb_id": kb_id,
    ...
    try:
        ...
        logger.error("Failed to update RAG configuration", extra={
            "kb_id": kb_id,
            "error": str(e)
        })
        return ShuResponse.error(
            message=str(e),
            code="RAG_CONFIG_UPDATE_ERROR",
            status_code=e.status_code
        )
    except Exception as e:
        logger.error("Unexpected error updating RAG configuration", extra={
            "kb_id": kb_id,
            "error": str(e)
        })
        return ShuResponse.error(
...
async def list_documents(
    ...
    search_query: Optional[str] = Query(None, description="Document title or content to search by"),
    ...
    try:
        ...
        documents, total = await kb_service.get_documents(kb_id, limit=limit, offset=offset, search_query=search_query, filter_by=filter_by)
    ...
    try:
        ...
        for doc in documents:
            ...
            if doc.extraction_confidence is not None:
                ...
                extraction_stats[method]["avg_confidence"] = (current_avg * (count - 1) + doc.extraction_confidence) / count
