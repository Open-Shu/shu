...
from typing import Optional, Sequence, Tuple, Dict, Any, Callable, List
import logging
...
from .query_service import COMPREHENSIVE_STOP_WORDS
...
async def process_query_for_rag(
    ...
    query_text: str,
    prior_messages: Optional[Sequence[Message]] = None,
    timeout_ms: int = 1200,
