    ...
    def test_property_migration_idempotence(
        ...
        **Validates: Requirements 2.4, 4.6**
        ...
        assert len(created_identities) == num_users, \
            f"Expected {num_users} identities, got {len(created_identities)}"
    ...
    def test_property_no_duplicate_identities_created(
        ...
        **Validates: Requirements 2.4, 4.6**
        ...
        assert len(insert_operations) == len(set(insert_operations)), \
            f"Duplicate inserts detected: {insert_operations}"
    ...
    def test_property_skips_existing_identities(
        ...
        **Validates: Requirements 2.4, 4.6**
        ...
        for user_id in insert_operations:
            assert user_id not in users_with_existing_identity, \
