...
def test_enhanced_source_visibility():
    ...
    try:
        ...
        test_documents = [
            {
                ...
                'metadata': {'file_type': 'pdf', 'source_url': 'https://example.com/high-relevance.pdf'}
            },
            {
                ...
                'metadata': {'file_type': 'docx', 'source_url': 'https://example.com/medium-relevance.docx'}
            },
            {
            ...
            },
            {
                ...
                'metadata': {'file_type': 'pdf', 'source_url': 'https://example.com/secret-study.pdf'}
            }
        ]
        ...
        print(f"   ✅ Found Secret document with title weighting")
        ...
        print(f"   ✅ Multiple relevance levels for filtering")
        print(f"   ✅ Title search with highlighting support")
        print(f"   ✅ Complete source metadata for enhanced display")
        print(f"   ✅ All search types working with visibility features")
        
        return True
        
    except Exception as e:
        print(f"\n❌ Enhanced Source Visibility Test FAILED: {str(e)}")
        import traceback
        traceback.print_exc()
        return False
