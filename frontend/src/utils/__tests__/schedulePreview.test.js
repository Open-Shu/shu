...
describe('schedulePreview', () => {
  describe('describe', () => {
    ...
    it('throws error for empty cron expression', () => {
      expect(() => describeSchedule('', 'America/New_York')).toThrow('Invalid cron expression');
    });

    it('throws error for null cron expression', () => {
      expect(() => describeSchedule(null, 'America/New_York')).toThrow('Invalid cron expression');
    });

    it('throws error for invalid timezone', () => {
      expect(() => describeSchedule('0 9 * * *', '')).toThrow('Invalid timezone');
    });

    it('throws error for null timezone', () => {
      expect(() => describeSchedule('0 9 * * *', null)).toThrow('Invalid timezone');
    });
  });
  ...
  describe('getNextExecutions', () => {
    ...
    it('throws error for empty cron expression', () => {
      expect(() => getNextExecutions('', 'America/New_York')).toThrow('Invalid cron expression');
    });

    it('throws error for invalid timezone', () => {
      expect(() => getNextExecutions('0 9 * * *', 'Invalid/Timezone')).toThrow();
    });
  ...
  describe('formatExecution', () => {
    ...
    it('throws error for invalid date', () => {
      expect(() => formatExecution(new Date('invalid'), 'America/New_York')).toThrow('Invalid date');
    });

    it('throws error for null date', () => {
      expect(() => formatExecution(null, 'America/New_York')).toThrow('Invalid date');
    });

    it('throws error for non-Date object', () => {
      expect(() => formatExecution('2026-01-14', 'America/New_York')).toThrow('Invalid date');
    });
  ...
  describe('getSchedulePreview', () => {
    ...
    it('throws error for empty cron expression', () => {
      expect(() => getSchedulePreview('', 'America/New_York')).toThrow('Invalid cron expression');
    });

    it('throws error for invalid timezone', () => {
      expect(() => getSchedulePreview('0 9 * * *', '')).toThrow('Invalid timezone');
    });
