...
export const pluginsAPI = {
  ...
  setSecret: (name, key, userId, value, scope = 'user') =>
    api.put(`/plugins/admin/${encodeURIComponent(name)}/secrets/${encodeURIComponent(key)}`, {
      user_id: userId,
      value,
      scope,
    }),
  deleteSecret: (name, key, userId, scope = 'user') =>
    api.delete(`/plugins/admin/${encodeURIComponent(name)}/secrets/${encodeURIComponent(key)}`, {
      params: { user_id: userId, scope },
    }),
  ...
  setSelfSecret: (name, key, value) =>
    api.put(`/plugins/self/${encodeURIComponent(name)}/secrets/${encodeURIComponent(key)}`, { value }),
  deleteSelfSecret: (name, key) =>
    api.delete(`/plugins/self/${encodeURIComponent(name)}/secrets/${encodeURIComponent(key)}`),
};
