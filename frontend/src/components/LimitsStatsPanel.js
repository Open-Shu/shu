    ...
    <Card variant="outlined" sx={{ mb: 2 }}>
      <CardContent>
        ...
        >
          ...
          <Stack direction="row" spacing={1}>
            <FormControl size="small" sx={{ minWidth: 220 }}>
              ...
              >
                <MenuItem value="rl:plugin:">
                  rl:plugin: — per-user/per-plugin rate limits
                </MenuItem>
                <MenuItem value="quota:d:">
                  quota:d: — daily quotas (reset end of day)
                </MenuItem>
                <MenuItem value="quota:m:">
                  quota:m: — monthly quotas (reset end of month)
                </MenuItem>
              </Select>
            </FormControl>
            <TextField
        ...
        <Typography variant="body2" color="text.secondary" sx={{ mb: 1 }}>
          Snapshot of raw Redis keys. Values and TTLs update live as requests
          flow. Use this for quick diagnostics; it is not an aggregated report.
        </Typography>
