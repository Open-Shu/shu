...
jest.mock('../import-wizard/YAMLInputStep', () => {
    ...
    return function MockYAMLInputStep({ yamlContent, onYAMLChange, onValidationChange, prePopulatedYAML }) {
        ...
        return mockReact.createElement('div', null,
            ...
            mockReact.createElement('p', null, `Current state: ${yamlContent ? `${yamlContent.length} characters` : 'Empty'}`),
...
jest.mock('../../services/yamlProcessor', () => ({
    convertToExperiencePayload: jest.fn(() => ({ name: 'Test Experience', description: 'Test' })),
...
describe('ImportExperienceWizard', () => {
    ...
    test('displays pre-populated YAML indicator', () => {
        ...
        renderWithQueryClient(
            <ImportExperienceWizard {...defaultProps} prePopulatedYAML={prePopulatedYAML} />
        );
