...
const STEPS = [
    { key: 'yaml-input', label: 'YAML Input', description: 'Provide or edit YAML configuration' },
    { key: 'placeholder-form', label: 'Configure Values', description: 'Fill in placeholder values' },
    { key: 'creation', label: 'Create Experience', description: 'Review and create the experience' },
];
