...
const QuickStart = () => {
  ...
  const gettingStartedSections = [
    ...
    },
    {
      title: "Add Documents",
      description:
        "Upload documents to your knowledge bases. These will be indexed for semantic search and retrieval.",
      icon: <DocumentsIcon />,
  ...
  const advancedSections = [
    {
      title: "Prompts",
      description:
        "Manage system prompts that define your assistant's behavior, personality, and response style.",
      icon: <PromptsIcon />,
      path: "/admin/prompts",
    },
    {
      title: "Branding",
      description:
        "Customize the look and feel of your application. Set logos, colors, and display names.",
      icon: <BrandingIcon />,
      path: "/admin/branding",
    },
  ];
  ...
  const accessControlSections = [
    {
      ...
      description:
        "Manage user accounts, roles, and authentication. Control who can access the system.",
      icon: <UsersIcon />,
      path: "/admin/users",
    },
    {
    ...
    },
    {
      ...
      description:
        "Control access to knowledge bases. Define which users or groups can view or edit each KB.",
      icon: <SecurityIcon />,
  ...
  const toolsSections = [
    ...
    },
    {
      title: "Query Tester",
      description:
        "Test vector search and retrieval against your knowledge bases. Debug and tune search quality.",
      icon: <QueryIcon />,
    ...
    },
    {
      title: "LLM Tester",
      description:
        "Send test prompts directly to configured LLM providers. Verify model responses and behavior.",
      icon: <LLMTesterIcon />,
    ...
    },
    {
      ...
      description:
        "Monitor system health, database connectivity, and service status in real-time.",
      icon: <HealthIcon />,
      path: "/admin/health",
    },
  ];
        ...
        {sections.map((section, index) => (
          ...
          >
            <SectionCard
              ...
              completed={
                section.statusKey
                  ? getCompletionStatus(section.statusKey)
                  : false
              }
  ...
  return (
    <Box>
      ...
      <Box
        sx={{ mt: 4, p: 2, backgroundColor: "action.hover", borderRadius: 2 }}
      >
        ...
        <Grid container spacing={2} sx={{ mt: 1 }}>
          <Grid item xs={12} md={4}>
            ...
            <Typography variant="body2" color="text.secondary">
              A searchable collection of documents. Used for RAG to give your AI
          ...
          <Grid item xs={12} md={4}>
            ...
            <Typography variant="body2" color="text.secondary">
              An extension that adds capabilities like email reading, calendar
              access, or web search.
            </Typography>
          </Grid>
          <Grid item xs={12} md={4}>
            <Typography variant="body2" sx={{ fontWeight: 500 }}>
            ...
            <Typography variant="body2" color="text.secondary">
              An automated job that runs a plugin operation on a schedule to
              sync data into a KB.
            </Typography>
          </Grid>
        </Grid>
