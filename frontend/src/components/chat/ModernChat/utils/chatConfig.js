...
// Feature toggles
export const CHAT_PLUGINS_ENABLED = parseBoolean(
  "REACT_APP_CHAT_PLUGINS_ENABLED",
  false,
);

// Windowing + scroll thresholds
export const CHAT_WINDOW_SIZE = parsePositiveInt(
  "REACT_APP_CHAT_WINDOW_SIZE",
  15,
);
export const CHAT_OVERSCAN = parseNonNegativeInt("REACT_APP_CHAT_OVERSCAN", 5);
export const CHAT_SCROLL_TOP_THRESHOLD = parseNonNegativeInt(
  "REACT_APP_CHAT_SCROLL_TOP_THRESHOLD_PX",
  120,
);
export const CHAT_SCROLL_BOTTOM_THRESHOLD = parseNonNegativeInt(
...
export const CONVERSATION_LIST_LIMIT = parsePositiveInt(
  "REACT_APP_CONVERSATION_LIST_LIMIT",
  50,
);

// Summary search behavior (allow env overrides; keep sane defaults)
export const SUMMARY_SEARCH_DEBOUNCE_MS = parsePositiveInt(
  "REACT_APP_SUMMARY_SEARCH_DEBOUNCE_MS",
  300,
);
export const DEFAULT_SUMMARY_SEARCH_MIN_TERM_LENGTH = parsePositiveInt(
  "REACT_APP_SUMMARY_SEARCH_MIN_TERM_LENGTH",
  3,
);
export const DEFAULT_SUMMARY_SEARCH_MAX_TOKENS = parsePositiveInt(
