...
// Mock conversations
const createMockConversation = (id, title, isFavorite = false, updatedAt = new Date()) => ({
  id,
  title,
...
describe('ConversationSidebar - Favorite Functionality', () => {
  ...
  describe('Favorite Button Rendering', () => {
    ...
    test('favorite button is visible on mobile', () => {
      ...
      render(
        <TestWrapper>
          <ConversationSidebar {...defaultProps} conversations={conversations} isMobile={true} />
        </TestWrapper>
      );
  ...
  describe('Favorite Toggle Interaction', () => {
    test('calls onToggleFavorite when favorite button is clicked', () => {
      const conversation = createMockConversation('1', 'Test Conversation', false);
    ...
    test('calls onToggleFavorite with correct conversation when unfavoriting', () => {
      const conversation = createMockConversation('1', 'Favorite Conversation', true);
      const conversations = [conversation];
    ...
    test('handles onToggleFavorite being undefined gracefully', () => {
      ...
      render(
        <TestWrapper>
          <ConversationSidebar {...propsWithoutToggle} conversations={conversations} />
        </TestWrapper>
      );
  ...
  describe('Conversation List Sorting', () => {
    test('displays conversations in the order provided (pre-sorted by parent)', () => {
      ...
      const conversations = [
        createMockConversation('2', 'Favorite 1', true, new Date('2024-01-15T10:00:00Z')),
        createMockConversation('4', 'Favorite 2', true, new Date('2024-01-15T09:00:00Z')),
        createMockConversation('3', 'Non-Favorite 2', false, new Date('2024-01-15T12:00:00Z')),
        createMockConversation('1', 'Non-Favorite 1', false, new Date('2024-01-15T11:00:00Z')),
      ];
    ...
    test('displays favorited conversations with star indicator', () => {
      ...
      const favoriteItem = screen.getByText('Favorite Conv').closest('.MuiListItemButton-root');
      const regularItem = screen.getByText('Regular Conv').closest('.MuiListItemButton-root');
      ...
      const regularTitleArea = within(regularItem).getByText('Regular Conv').parentElement;
      const regularStarsInTitle = within(regularTitleArea).queryAllByTestId('StarIcon');
    ...
    test('preserves conversation order when provided', () => {
      ...
      const conversations = [
        createMockConversation('3', 'Third', false, new Date('2024-01-15T10:00:00Z')),
        createMockConversation('1', 'First', true, new Date('2024-01-15T12:00:00Z')),
        createMockConversation('2', 'Second', false, new Date('2024-01-15T11:00:00Z')),
      ];
  ...
  describe('Integration Tests', () => {
    test('favorite button works correctly with selected conversation', () => {
      const conversation = createMockConversation('1', 'Selected Conversation', false);
      const conversations = [conversation];
