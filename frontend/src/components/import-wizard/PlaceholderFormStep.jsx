            ...
            <Box>
                ...
                <Alert severity="success" sx={{ mb: 2 }}>
                    <Typography variant="body2">
                        No configuration placeholders found in the YAML. 
                        The experience is ready to be created as-is.
                    </Typography>
                </Alert>
    ...
    return (
        <Box>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
                Fill in the configuration values for your imported experience. 
                These settings will replace the placeholders in the YAML.
            </Typography>
