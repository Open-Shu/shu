...
describe('TimezoneSelector', () => {
  ...
  test('shows custom helper text', () => {
    render(<TimezoneSelector {...defaultProps} helperText="Custom helper text" />);
  ...
  test('renders with custom placeholder', () => {
    render(<TimezoneSelector {...defaultProps} value="" placeholder="Choose a timezone" />);

    expect(screen.getByPlaceholderText('Choose a timezone')).toBeInTheDocument();
  });

  test('can be set to not full width', () => {
    const { container } = render(<TimezoneSelector {...defaultProps} fullWidth={false} />);
