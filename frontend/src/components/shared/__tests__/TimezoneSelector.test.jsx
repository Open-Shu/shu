...
describe("TimezoneSelector", () => {
  ...
  test("shows helper text", () => {
    ...
    expect(
      screen.getByText("Choose the timezone for schedule execution"),
    ).toBeInTheDocument();
  });

  test("shows custom helper text", () => {
    render(
      <TimezoneSelector {...defaultProps} helperText="Custom helper text" />,
    );
  ...
  test("renders with custom placeholder", () => {
    ...
    expect(
      screen.getByPlaceholderText("Choose a timezone"),
    ).toBeInTheDocument();
  });
