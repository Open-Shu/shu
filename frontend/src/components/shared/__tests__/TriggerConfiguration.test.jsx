...
describe('TriggerConfiguration', () => {
  ...
  test('shows validation errors', () => {
    render(<TriggerConfiguration {...defaultProps} validationErrors={{ trigger_type: 'Required field' }} />);
  ...
  test('resets config when trigger type changes', () => {
    const { container } = render(
      <TriggerConfiguration {...defaultProps} triggerConfig={{ scheduled_at: '2024-01-01T10:00' }} />
    );
